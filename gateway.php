...
class Gateway {
	 ...
	 */
	static public $hostedUrl = 'https://gw1.tponlinepayments.com/paymentform/';

	/**
	 * @var string	Gateway Direct API Endpoint
	 */
	static public $directUrl = 'https://gw1.payzoneonlinepayments2.com/direct/';

	/**
	 * @var string	Merchant Account Id or Alias
	 */
	static public $merchantID;// = '116993';
	 ...
	 */
	static public $merchantSecret;// = 'J5eumB2w9rHX3eW3';
	 ...
	 *
	 * The method will attempt to send the request using the PHP cURL extention
	...
	static public function hostedRequest(array $request, array $options = null) {
		...
		if (isset($options['submitImage'])) {
			...
			$ret .= '<input ' .
					(isset($options['submitAttrs']) ? $options['submitAttrs'] : '') .
					' type="submit" class="pay" value="' . (isset($options['submitText']) ? htmlentities($options['submitText'], ENT_COMPAT, 'UTF-8') : 'Pay Now') . "\">\n";
		}
	 ...
	 *   + 'merchantPwd'	- Merchant Account Password (or null)
	 *
	 * The method will {@link sign() sign} the request if a secret is available.
	 *
