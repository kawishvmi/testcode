...
*/
namespace Payzone\Gateway\PaymentSystem;
...
use Payzone\Gateway\SOAP as SOAP;
...
class BillingAddress
{
  ...
  */
  ...
  public function __construct()
  {
    ...
    $this->m_szState = "";
    $this->m_szPostCode = "";
    $this->m_nCountryCode = new Common\NullableInt();
  }
...
abstract class CreditCardDate
{
  ...
  */
  ...
  public function __construct()
  {
    $this->m_nMonth = new Common\NullableInt();
    $this->m_nYear = new Common\NullableInt();
  }
...
class MessageDetails
{
  ...
  */
  ...
  public function __construct()
  {
    ...
    $this->m_boNewTransaction = new Common\NullableBool();
...
class TransactionDetails
{
  ...
  */
  ...
  public function __construct()
  {
    ...
    $this->m_nAmount = new Common\NullableInt();
    $this->m_szCaptureEnvironment = "";
    $this->m_boContinuousAuthority = new Common\NullableBool();
    $this->m_nCurrencyCode = new Common\NullableInt();
    $this->m_szOrderID = "";
...
class ThreeDSecureBrowserDetails
{
  ...
  */
  ...
  public function __construct()
  {
    $this->m_nDeviceCategory = new Common\NullableInt();
...
class TransactionControl
{
  ...
  */
  ...
  public function __construct()
  {
    $this->m_boEchoCardType = new Common\NullableBool();
    $this->m_boEchoAVSCheckResult = new Common\NullableBool();
    $this->m_boEchoCV2CheckResult = new Common\NullableBool();
    $this->m_boEchoAmountReceived = new Common\NullableBool();
    $this->m_nDuplicateDelay = new Common\NullableInt();
    $this->m_szAVSOverridePolicy = "";
    $this->m_szCV2OverridePolicy = "";
    $this->m_boThreeDSecureOverridePolicy = new Common\NullableBool();
    $this->m_szAuthCode = "";
...
class Issuer
{
  ...
  */
  ...
  //constructor
  public function __construct($szIssuer, Common\NullableInt $nISOCode = null)
  {
...
class CardTypeData
{
  ...
  */
  public function __construct($szCardType, $szCardClass, $iIssuer, Common\NullableBool $boLuhnCheckRequired = null, $szIssueNumberStatus, $szStartDateStatus)
  {
...
class GatewayEntryPointList
{
  ...
  */
  ...
  {
    $xpXmlParser = new Common\XmlParser();
...
class PreviousTransactionResult
{
  ...
  */
  function __construct(Common\NullableInt $nStatusCode = null, $szMessage)
  {
...
class GatewayOutput
{
  ...
  * @param string     $szMessage
  * @param Common\StringList $lszErrorMessages
  */
  public function __construct($nStatusCode, $szMessage, Common\StringList $lszErrorMessages = null)
  {
    $this->m_nStatusCode = $nStatusCode;
    $this->m_szMessage = $szMessage;
...
class PaymentMessageGatewayOutput extends GatewayOutput
{
  ...
  * @param Common\StringList                $lszErrorMessages
  */
  public function __construct($nStatusCode, $szMessage, Common\NullableBool $boAuthorisationAttempted = null, PreviousTransactionResult $ptdPreviousTransactionResult = null, Common\StringList $lszErrorMessages = null)
  {
...
class GetGatewayEntryPoints extends GatewayTransaction
{
  ...
  */
  function processTransaction(GetGatewayEntryPointsResult &$ggeprGetGatewayEntryPointsResult = null, GetGatewayEntryPointsOutputData &$ggepGetGatewayEntryPointsOutputData = null)
  {
    ...
    $sSOAPClient = new SOAP\SOAP("GetGatewayEntryPoints", GatewayTransaction::getSOAPNamespace());
  ...
  */
  public function __construct(RequestGatewayEntryPointList $lrgepRequestGatewayEntryPoints = null, $nRetryAttempts = 1, Common\NullableInt $nTimeout = null)
  {
...
class CardDetailsTransaction extends GatewayTransaction
{
  ...
  */
  public function processTransaction(CardDetailsTransactionResult &$cdtrCardDetailsTransactionResult = null, TransactionOutputData &$todTransactionOutputData = null)
  {
    ...
    $sSOAPClient = new SOAP\SOAP("CardDetailsTransaction", parent::getSOAPNamespace());
    ...
    if ($this->m_tdTransactionDetails != null)
    {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getCaptureEnvironment()))
      {
      ...
      {
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getMessageDetails()->getClientReference()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getMessageDetails()->getTransactionType()))
        {
      ...
      {
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getAuthCode()))
        {
        ...
        if ($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecureOverridePolicy() != null)
        {
          ...
          {
            $sSOAPClient->addParam("PaymentMessage.TransactionDetails.TransactionControl.ThreeDSecureOverridePolicy",Common\SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecureOverridePolicy()->getValue()));
          }
        }
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getAVSOverridePolicy()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getCV2OverridePolicy()))
        {
        ...
        if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoCardType() != null)
        {
          ...
          {
            $sSOAPClient->addParam("PaymentMessage.TransactionDetails.TransactionControl.EchoCardType", Common\SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoCardType()->getValue()));
          }
        }
        if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoAVSCheckResult() != null)
        {
          ...
          {
            $sSOAPClient->addParam("PaymentMessage.TransactionDetails.TransactionControl.EchoAVSCheckResult", Common\SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoAVSCheckResult()->getValue()));
          }
        }
        if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoAVSCheckResult() != null)
        {
        ...
        if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoCV2CheckResult() != null)
        {
          ...
          {
            $sSOAPClient->addParam("PaymentMessage.TransactionDetails.TransactionControl.EchoCV2CheckResult", Common\SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoCV2CheckResult()->getValue()));
          }
        }
        if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoAmountReceived() != null)
        {
          ...
          {
            $sSOAPClient->addParam("PaymentMessage.TransactionDetails.TransactionControl.EchoAmountReceived", Common\SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoAmountReceived()->getValue()));
          }
        }
        if ($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData() != null)
        {
          if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getEnrolmentStatus()))
          {
          ...
          if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getAuthenticationStatus()))
          {
          ...
          if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getElectronicCommerceIndicator()))
          {
          ...
          if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getAuthenticationValue()))
          {
          ...
          if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getTransactionIdentifier()))
          {
      ...
      {
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getThreeDSecureBrowserDetails()->getAcceptHeaders()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getThreeDSecureBrowserDetails()->getUserAgent()))
        {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getOrderID()))
      {
        $sSOAPClient->addParam("PaymentMessage.TransactionDetails.OrderID", $this->m_tdTransactionDetails->getOrderID());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getOrderDescription()))
      {
    ...
    {
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getCardName()))
      {
        $sSOAPClient->addParam("PaymentMessage.CardDetails.CardName", $this->m_cdCardDetails->getCardName());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getCV2()))
      {
        $sSOAPClient->addParam("PaymentMessage.CardDetails.CV2", $this->m_cdCardDetails->getCV2());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getCardNumber()))
      {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getIssueNumber()))
      {
    ...
    if ($this->m_cdCustomerDetails != null)
    {
      ...
      {
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress1()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress2()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress3()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress4()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getCity()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getState()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getPostCode()))
        {
      ...
      if ($this->m_cdCustomerDetails->getPrimaryAccountDetails() != null)
      {
        ...
        {
          if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getPrimaryAccountDetails()->getAddressDetails() ->getPostCode()))
          {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getPrimaryAccountDetails()->getName()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getPrimaryAccountDetails()->getAccountNumber()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getPrimaryAccountDetails()->getDateOfBirth()))
        {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getEmailAddress()))
      {
        $sSOAPClient->addParam("PaymentMessage.CustomerDetails.EmailAddress", $this->m_cdCustomerDetails->getEmailAddress());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getPhoneNumber()))
      {
        $sSOAPClient->addParam("PaymentMessage.CustomerDetails.PhoneNumber", $this->m_cdCustomerDetails->getPhoneNumber());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getCustomerIPAddress()))
      {
...
class CrossReferenceTransaction extends GatewayTransaction
{
  ...
  */
  public function processTransaction(CrossReferenceTransactionResult &$crtrCrossReferenceTransactionResult = null, TransactionOutputData &$todTransactionOutputData = null)
  {
    ...
    $sSOAPClient = new SOAP\SOAP("CrossReferenceTransaction", GatewayTransaction::getSOAPNamespace());
    // transaction details
    if ($this->m_tdTransactionDetails != null)
    {
      if ($this->m_tdTransactionDetails->getAmount() != null)
      ...
      if ($this->m_tdTransactionDetails->getMessageDetails() != null)
      {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getMessageDetails()->getPreviousClientReference()))
        {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getMessageDetails()->getCrossReference()))
        {
      ...
      if ($this->m_tdTransactionDetails->getTransactionControl() != null)
      {
        ...
        if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecureOverridePolicy()))
        {
          if ($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecureOverridePolicy()->getHasValue())
          {
    ...
    {
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getCardName()))
      {
        $sSOAPClient->addParam("PaymentMessage.OverrideCardDetails.CardName", $this->m_ocdOverrideCardDetails->getCardName());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getCV2()))
      {
        $sSOAPClient->addParam("PaymentMessage.OverrideCardDetails.CV2", $this->m_ocdOverrideCardDetails->getCV2());
      }
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getCardNumber()))
      {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getIssueNumber()))
      {
...
class ThreeDSecureAuthentication extends GatewayTransaction
{
  ...
  */
  public function processTransaction(ThreeDSecureAuthenticationResult &$tdsarThreeDSecureAuthenticationResult = null, TransactionOutputData &$todTransactionOutputData = null)
  {
    ...
    $sSOAPClient = new SOAP\SOAP("ThreeDSecureAuthentication", GatewayTransaction::getSOAPNamespace());
    if ($this->m_tdsidThreeDSecureInputData != null)
    {
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdsidThreeDSecureInputData->getCrossReference()))
      {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_tdsidThreeDSecureInputData->getPaRES()))
      {
...
class GetCardType extends GatewayTransaction
{
  ...
  */
  public function processTransaction(GetCardTypeResult &$gctrGetCardTypeResult = null, GetCardTypeOutputData &$gctodGetCardTypeOutputData = null)
  {
    ...
    $sSOAPClient = new SOAP\SOAP("GetCardType", GatewayTransaction::getSOAPNamespace());
...
abstract class GatewayTransaction
{
  ...
  * @throws Exception
  */
  protected function processTransactionBase(SOAP\SOAP $sSOAPClient, $szMessageXMLPath, $szGatewayOutputXMLPath, $szTransactionMessageXMLPath, GatewayOutput &$goGatewayOutput = null, GatewayEntryPointList &$lgepGatewayEntryPoints = null)
  {
    $boTransactionSubmitted = false;
    ...
    {
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_maMerchantAuthentication->getMerchantID()))
      {
      ...
      if (!Common\SharedFunctions::isStringNullOrEmpty($this->m_maMerchantAuthentication->getPassword()))
      {
    ...
    $number = $this->m_lrgepRequestGatewayEntryPoints->sort("Payzone\Gateway\PaymentSystem\GatewayTransaction", "Compare");
            ...
            if ($sSOAPClient->sendRequest())
            {
              if ($sSOAPClient->getXmlTag()->getIntegerValue($szGatewayOutputXMLPath . ".StatusCode", $nStatusCode))
              {
                ...
                if ($nStatusCode != 50)
                {
                  ...
                  $nErrorMessageCount = 0;
                  $lszErrorMessages = new Common\StringList();
...
class SharedFunctionsPaymentSystemShared
{
  ...
  * @throws Exception
  */
  public static function getTransactionOutputData(Common\XmlTag $xtTransactionOutputDataXmlTag, GatewayEntryPointList $lgepGatewayEntryPoints = null)
  {
    $szCrossReference = "";
    ...
    {
      $nAmountReceived = new Common\NullableInt($nTempValue);
    }
    ...
    if (!Common\SharedFunctions::isStringNullOrEmpty($szACSURL) && !Common\SharedFunctions::isStringNullOrEmpty($szPaREQ))
    {
  ...
  * @throws Exception
  */
  public static function getCardTypeData(Common\XmlTag $xtGetCardTypeXmlTag, $szCardTypeDataXMLPath)
  {
    $ctdCardTypeData = null;
    $boTempValue;
    $nISOCode = null;
    ...
    if ($xtGetCardTypeXmlTag->getStringValue($szCardTypeDataXMLPath . ".CardType", $szCardType))
    {
      ...
      {
        $nISOCode = new Common\NullableInt($nTemp);
      }
      ...
      {
        $boLuhnCheckRequired = new Common\NullableBool($boTempValue);
      }
  ...
  * @throws Exception
  */
  public static function getPaymentMessageGatewayOutput(Common\XmlTag $xtMessageResultXmlTag, $szGatewayOutputXMLPath, GatewayOutput $goGatewayOutput = null)
  {
    $nTempValue = 0;
    ...
    {
      $boAuthorisationAttempted = new Common\NullableBool($boTempValue);
    }
    ...
    {
      $nPreviousStatusCode = new Common\NullableInt($nTempValue);
    }
    $xtMessageResultXmlTag->getStringValue($szGatewayOutputXMLPath . ".PreviousTransactionResult.Message", $szPreviousMessage);
    if ($nPreviousStatusCode != null && !Common\SharedFunctions::isStringNullOrEmpty($szPreviousMessage))
    {
