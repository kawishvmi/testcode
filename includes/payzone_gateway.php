...
require_once(__DIR__ .'/gateway/constants.php');
//require_once(__DIR__ .'/helpers/db_example.php');#DBExample
require_once(__DIR__ .'/helpers/payzone_helper.php');

//use Payzone\Helpers\DBControl as DB;#DBExample
...
/**
 * [PayzoneGateway Main payzone gateway payment processing class, contains all of the functions for sending and receiving data, and handles formatting and passing the information across to the payment gateway, form handlers nad response handlers]
...
class PayzoneGateway
{
  ...
  public function __construct()
  {
    ...
    // DB\DBDemo::saveConfiguration('MerchantID', '***EnterMerchantID***');#DBExample
    // DB\DBDemo::saveConfiguration('MerchantPassword', '***EnterMerchantID***');#DBExample
    // DB\DBDemo::saveConfiguration('PreSharedKey', '***EnterPreSharredKey***');#DBExample
    // DB\DBDemo::saveConfiguration('SecretKey', '***EnterSecretKey***');#DBExample
    // DB\DBDemo::saveConfiguration('IntegrationType', Constants\INTEGRATION_TYPE::HOSTED);#DBExample
    ...
    // DB\DBDemo::saveConfiguration('ResultMethod', Constants\RESULT_DELIVERY_METHOD::SERVER_PULL);#DBExample
    ...
    self::setMerchantId('119837');// Enter the merchant ID from the MMS
    self::setMerchantPassword('');// Enter the merchant Password from the MMS
    self::setPreSharedKey('9GXwHNVC87VqsqNM');// Enter the pre shared key from the MMS
    self::setSecretKey('');// secret key used to protect and verify data
    self::setIntegrationType(Constants\INTEGRATION_TYPE::TRANSPARENT);
    ...
    self::setHostedCustomerDetails(false);
    ...
    self::setURL('process-payment', 'process.php'); #processes the payment as required
    ...
    public function versionCheck()
    {
      ...
      $url = "https://payzone-modules.co.uk/api/api.php?action=version_check&module=custom-module&version=$plugin_version&key=8U2egXStxFiNA1YnFrfu9MN1DU1x1YO5P3qT3exC";
        $options = array(
    ...
    public function setURL($act, $val = null)
{
      ##### DEVELOPER NOTE #####
      #~~~~~~~~~~~~~~~~~~~~~~~~~~#
      # If you change the overall file structure of the payment module then you will need to amend the below functions to return the correct URLs as required. If you are nesting or including the content it may also be required to change the Helper\PayzoneHelper::getSiteSecureURL() function.
      #~~~~~~~~~~~~~~~~~~~~~~~~~~#
      ############################
      switch ($act) {
        case 'home-page':
        ...
        default:
          switch ($v) {
            case 'Title':
              ...
              break;
            case 'Message':
              $return = "Sorry, your payment has not been successful. Please try again, if the problem persists please get in touchs.";
              break;
            default:
            case 'Type':
...
##### DEVELOPER NOTE #####
#~~~~~~~~~~~~~~~~~~~~~~~~~~#
# This checks if the debug mode is enabled and spits out all of the $POST and $GET content if it is enabled, this is not recommended for production
# As this poses a security risk of too much information being available.
# A message will be presented to all users on all Payzone pages that debug mode is active.
#~~~~~~~~~~~~~~~~~~~~~~~~~~#
############################
