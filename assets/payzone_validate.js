 ...
 */
function validateForm(cartForm,intType,full = null){
  ...
  switch (intType) {
    case 'transparent':
      if (full=="true"){
        ...
        validateInput(cartForm,'CountryCode') ? null : errors.push("CountryCode is missing");
        validateInput(cartForm,'HashDigest') ? null : errors.push("Hash Digest is missing");
        validateInput(cartForm,'MerchantID') ? null : errors.push("Merchant ID is missing");
        validateInput(cartForm,'CurrencyCode') ? null : errors.push("CurrencyCode is missing");
        validateInput(cartForm,'TransactionType') ? null : errors.push("Transaction Type is missing");
        validateInput(cartForm,'CallbackURL') ? null : errors.push("Callback URL is missing");
        validateInput(cartForm,'TransactionDateTime') ? null : errors.push("Transaction time is missing");
        validateInput(cartForm,'Amount') ? null : errors.push("Amount is missing");
      }
  ...
  if (errors.length>0){
    error_warnings="<p class='error_title'>Errors have been found in the form</p>";
    for (error in errors){
